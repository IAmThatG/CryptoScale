...
public class BitcoinConversionActivity extends AppCompatActivity
{
    ...
    private Button btnBTCConversion;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_bitcoin_conversion);

        conversionRate = getIntent().getDoubleExtra("CONVERSION_RATE", 0);
        currencyName = getIntent().getStringExtra("CURRENCY_NAME");

        btnBTCConversion = (Button) findViewById(R.id.btn_btc_convert);
        resultTxtView = (TextView) findViewById(R.id.btc_conversion_result_txt_view);

        amountEditTxt = (EditText) findViewById(R.id.btc_amount_edit_text);
    ...
    {
        btnBTCConversion.setOnClickListener(new View.OnClickListener()
        {
            @Override
